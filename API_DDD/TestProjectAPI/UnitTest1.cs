...
namespace TestProjectAPI
{
    ...
    public class UnitTest1
    {
        ...
        {
            var result = ChamaApiPost("https://localhost:7208/api/List").Result;
        ...
        public void GetToken()
        {
            ...
            string urlApiGeraToken = "https://localhost:7208/api/CriarTokenIdentity";

            using (var cliente = new HttpClient())
            {
                string login = "teste@teste.com";
                string senha = "@TesteNetCore123";
                var dados = new
                {
                    email = login,
                    senha = senha,
